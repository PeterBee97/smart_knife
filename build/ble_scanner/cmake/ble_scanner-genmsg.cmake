...
set(MSG_I_FLAGS "-Ible_scanner:/home/peter/ble_ws/src/ble_scanner/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/peter/ble_ws/src/ble_scanner/msg/BLEData.msg" NAME_WE)
add_custom_target(_ble_scanner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ble_scanner" "/home/peter/ble_ws/src/ble_scanner/msg/BLEData.msg" "ble_scanner/BLEBeacon:std_msgs/Header"
)

get_filename_component(_filename "/home/peter/ble_ws/src/ble_scanner/msg/BLEBeacon.msg" NAME_WE)
add_custom_target(_ble_scanner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ble_scanner" "/home/peter/ble_ws/src/ble_scanner/msg/BLEBeacon.msg" ""
)
...
_generate_msg_cpp(ble_scanner
  ...
  "${MSG_I_FLAGS}"
  "/home/peter/ble_ws/src/ble_scanner/msg/BLEBeacon.msg;/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ble_scanner)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ble_scanner\")")
  # install generated code
  install(
